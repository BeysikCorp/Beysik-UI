...
const Basics = () => {
  ...
  useEffect(() => {
    // Filter products tagged as 'basics'
    const basicsItems = allProducts.filter(p => p.tags && p.tags.includes('basics'));
    setProducts(basicsItems);
    setFilteredProducts(basicsItems);
  }, []);
